...
### License Validation
- License keys are validated against `validate.torbenit.dk` over HTTPS
- Validation results are cached locally for 24 hours (configurable)
- No sensitive data is transmitted — only the license key and product name
